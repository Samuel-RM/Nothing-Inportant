# Que se ingrese un nombre y 
# edad para luego compararlos para indicar cual de las dos personas(como minimo) es mayor

class Persona(object):
    def __init__(self, Nombre, Edad):
        self.nombre = Nombre
        self.edad = Edad
        # Cuando ponemos parametros para las funciones dentro de un 
        # objeto siempre debemos usar el self para que estemos referenciando siempre al mismo objeto
